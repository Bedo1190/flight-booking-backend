...
class AirportServiceTest {
    ...
    void shouldAddAirport() {
        // Arrange
        AirportRequest request = new AirportRequest("Istanbul Airport", "Istanbul", "IST");
        Airport savedAirport = new Airport(1L, "Istanbul Airport", "Istanbul", "IST");
    ...
    void shouldSearchAirports() {
        // Arrange
        Airport airport = new Airport(1L, "Istanbul Airport", "Istanbul", "IST");
